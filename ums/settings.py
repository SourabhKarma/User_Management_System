...
SECRET_KEY = 'django-insecure-aolc9xha_f@%l@k5a@7zs*xw#tj=n*pu9uw=6e=!qct^6#73&b'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'reset_password_scope':'3/minutes',
        'resend_opt_scope':'3/minutes',
        'login_scope':'3/minutes',
        # 'refresh_scope':'10/minutes',
        # 'anon':'10/minutes',
    },
